<?php
	...
	$handle1 = fopen ("truck.csv", "r");
	while ($array = fgetcsv ($handle1, 146, ';')) {
		if ($array[0]) {
			$matriz [] = $array;
			$nombre_indice_temporal = $array[2];
			$array_medidas_de_cada_producto [$nombre_indice_temporal][] = $array[5];
			$nombre_indice_temporal2 = $array[5];
	...
	while ($matriz[$iterador][0]) {
		$medida = str_replace ('r', '-r', strtolower($matriz[$iterador][5]));
		...
		if (!is_file ('truck/' . $string_nombre_archivo . '.htm') ) {
			$archivo = fopen ('truck/' . $string_nombre_archivo . '.htm', "w");
...
<meta name=\"keywords\" content=\"NEUMATICO " .  $matriz[$iterador][5] . " " . strtoupper ($matriz[$iterador][2]) . " - NEUMATICOS GOODYEAR " . 
	$medida_separada_para_imprimir . "\">
<meta name=\"description\" content=\"NEUMATICO " . $matriz[$iterador][5] . " " . strtoupper ($matriz[$iterador][2]) . " - NEUMATICOS GOODYEAR " .
	$medida_separada_para_imprimir . "\">
<title>NEUMATICO " . $matriz[$iterador][5] . " " . strtoupper ($matriz[$iterador][2]) . " - NEUMATICOS GOODYEAR " . $medida_separada_para_imprimir . "</title>
<style type=\"text/css\">
body
{
font-family: Arial; 
...
<div align=\"center\">
  ...
  <table cellspacing=\"0\" id=\"AutoNumber1\" bordercolor=\"#111111\" border=\"0\" height=\"89\" cellpadding=\"6\" width=\"600\" style=\"border-collapse: collapse\">
    <tr>
      ...
      GOODYEAR<br>" . $matriz[$iterador][5] . " " . strtoupper ($matriz[$iterador][2]) . "</font></p></td>
    </tr>
  </table>
  </center>
</div>
<div align=\"center\">
  ...
  <table cellspacing=\"0\" id=\"AutoNumber3\" bordercolor=\"#111111\" border=\"0\" cellpadding=\"6\" width=\"600\" style=\"border-collapse: collapse\">
    ...
    <tr>
      ...
      <img src=\"cuadrado-negro.gif\" border=\"0\" height=\"12\" width=\"11\"> " . $matriz[$iterador][5] . " " . 
...
<div align=\"center\">
  ...
  <div align=\"center\">
    <table border=\"0\" cellpadding=\"6\" cellspacing=\"0\" width=\"600\" id=\"table2\">
      <tr>
		<td>
         <font face=\"Arial\" size=\"2\" color=\"#00923F\">Otros modelos en " . $matriz[$iterador][5] . "</font></td>
	  </tr>
	  <tr><td style=\"border-bottom-style: solid; border-bottom-width: 1px\">";
			foreach ($matriz_productos_de_cada_medida[$matriz[$iterador][5]] as $value) {
  ...
  <table cellspacing=\"0\" border=\"0\" height=\"55\" cellpadding=\"0\" width=\"600\">
    ...
    <tr>
      ...
      <form action=\"http://www.viarrural.com.ar/local-cgi/FormMail.pl\" method=\"post\">
        ...
        <input name=\"subject\" type=\"hidden\" value=\"GOODYEAR - " . strtoupper ($matriz[$iterador][2]) . " - " . $matriz[$iterador][5] . "\">
        <div align=\"center\">
          <div align=\"center\">
