<?
	...
	$archivo = fopen ('goodyear truck/' . $string_nombre_archivo . '.htm', "w");
    ...
    <tr>
      ...
      <td align=\"center\" width=\"87\"><font face=\"Arial\" size=\"2\">Carga<br>máxima (kg)</font></td>
	...
	while ($matriz[$iterador + 1]) {
		fwrite ($archivo, "<tr>
			<td align=\"center\" width=\"99\"><font face=\"Arial\" size=\"2\">" . $matriz[$iterador][3] . "</font></td>
			<td align=\"center\" width=\"76\"><font face=\"Arial\" size=\"2\">" . $matriz[$iterador][1] . "</font></td>
			<td align=\"center\" width=\"96\"><font face=\"Arial\" size=\"2\">" . $matriz[$iterador][7] . "</font></td>
			<td align=\"center\" width=\"103\"><font face=\"Arial\" size=\"2\">" . $matriz[$iterador][8] . "</font></td>
			<td align=\"center\" width=\"87\"><font face=\"Arial\" size=\"2\">" . $matriz[$iterador][5] . "</font></td>
			<td align=\"center\" width=\"87\"><font face=\"Arial\" size=\"2\">" . $matriz[$iterador][4] . "</font></td>
			<td align=\"center\" width=\"137\"><font face=\"Arial\" size=\"2\">" . $matriz[$iterador][10] . "</font></td></tr>");
	...
	fwrite ($archivo, "<tr>
			...
			<td align=\"center\" width=\"87\"><font face=\"Arial\" size=\"2\">" . $matriz[$iterador][5] . "</font></td>
			<td align=\"center\" width=\"87\"><font face=\"Arial\" size=\"2\">" . $matriz[$iterador][4] . "</font></td>
			<td align=\"center\" width=\"137\"><font face=\"Arial\" size=\"2\">" . $matriz[$iterador][10] . "</font></td>
