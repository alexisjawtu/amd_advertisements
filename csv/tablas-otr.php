<?
	...
	$i = 0;
	while ($array = fgetcsv ($handle1, 53, ';')) {
		if ($array[0]) {
			$matriz [] = $array;
	...
	if (mkdir ('goodyear otr')) echo "<br>\n<br>\nDirectorio inicializado...<br>\n<br>\n";
	print_r ($matriz);
	$archivo = fopen ('goodyear otr/' . $string_nombre_archivo . '.htm', "w");
    ...
    <tr>
      ...
      <td align=\"center\" width=\"76\"><font face=\"Arial\" size=\"2\">Ancho total</font></td>
	  <td align=\"center\" width=\"137\"><font face=\"Arial\" size=\"2\">Carga máxima</font></td>
      <td align=\"center\" width=\"96\"><font face=\"Arial\" size=\"2\">Presión de aire</font></td>
      <td align=\"center\" width=\"137\"><font face=\"Arial\" size=\"2\">Diámetro total* (mm)</font></td>
    </tr>");
	while ($matriz[$iterador + 1]) {
		fwrite ($archivo, "<tr>
			<td align=\"center\" width=\"99\"><font face=\"Arial\" size=\"2\"><nobr>" . $matriz[$iterador][1] . "</nobr></font></td>
			<td align=\"center\" width=\"76\"><font face=\"Arial\" size=\"2\"><nobr>" . $matriz[$iterador][2] . "</nobr></font></td>
